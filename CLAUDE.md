...
- **MANDATORY**: All calculators and category pages must include authority signals as per `docs/general-template-guidelines (10).md` section 5
...
- **Authority Signals**: All new calculators must include Sources & Methodology section with authoritative references appropriate to the calculator category (Finance: Fed Reserve/IRS, Math: Wolfram/NIST, Health: CDC/Mayo Clinic, etc.)
- **Template Compliance**: Always use latest `calculator-template.html` and `category-template.html` 
- **Quality Assurance**: Include author verification in footer and quality statements in category pages
- **Reference Guidelines**: See `docs/general-template-guidelines (10).md` section 5 for complete authority signals requirements
